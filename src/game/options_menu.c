...
static struct Option optsCheats[] = {
    ...
    DEF_OPT_TOGGLE(optsCheatsStr[10], &Cheats.TPF),
    DEF_OPT_CHOICE(optsCheatsStr[11], &Cheats.JB, SeqChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[12], &Cheats.JBC),
    DEF_OPT_TOGGLE(optsCheatsStr[13], &Cheats.QuikEnd),
    DEF_OPT_CHOICE(optsCheatsStr[14], &Cheats.Hurt, HurtCheatChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[15], &Cheats.Cann),
    DEF_OPT_TOGGLE(optsCheatsStr[16], &Cheats.AutoWK),
    DEF_OPT_TOGGLE(optsCheatsStr[17], &Cheats.GetShell),
    DEF_OPT_TOGGLE(optsCheatsStr[18], &Cheats.GetBob),
    DEF_OPT_CHOICE(optsCheatsStr[19], &Cheats.Spamba, SpamCheatChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[20], &Cheats.Swim),
    DEF_OPT_BUTTON(optsCheatsStr[21], setCap_Wing),
    DEF_OPT_BUTTON(optsCheatsStr[22], setCap_Metal),
    DEF_OPT_BUTTON(optsCheatsStr[23], setCap_Vanish),
    DEF_OPT_BUTTON(optsCheatsStr[24], setCap_Remove),
