...
struct Character charmap[339] = {
    ...
    {"{00234}", {0x71, NULL}}, {"{00235}", {0x72, NULL}}, {"{00233}", {0x73, NULL}}, {"{00200}", {0x74, NULL}}, {"{00202}", {0x75, NULL}}, {"{00203}", {0x76, NULL}}, {"{00201}", {0x77, NULL}}, {"{00249}", {0x80, NULL}}, {"{00251}", {0x81, NULL}}, 
    {"{00252}", {0x82, NULL}}, {"{00217}", {0x84, NULL}}, {"{00219}", {0x85, NULL}}, {"{00220}", {0x86, NULL}}, {"{00244}", {0x91, NULL}}, {"{00246}", {0x92, NULL}}, {"{00212}", {0x95, NULL}}, {"{00214}", {0x96, NULL}}, {"{00238}", {0xa1, NULL}}, 
